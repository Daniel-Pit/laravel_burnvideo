...
<script>
    ...
    function onSubmitAdd()
    {
		...
		var url = "/admin/api_sendMailById";
		$.post( url, { 'title':title, 'usersfrom':usersfrom, 'usersend':usersend, 'message':subject, 'sender': sender })
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Messages By ID</h3>  
                    <div class="box-tools">                                        
