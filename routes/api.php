...
//});
    ...
    Route::get('/awsOrder', array('as' => 'awsConvertOrder', 'uses' => 'ApiController@awsConvertOrder'));
    Route::get('/awsTestOrder', array('as' => 'awsTestConvertOrder', 'uses' => 'ApiController@awsTestConvertOrder'));
    Route::get('/OrderCheck', array('as' => 'awsSubmitOrder', 'uses' => 'ApiController@awsSubmitOrder'));
